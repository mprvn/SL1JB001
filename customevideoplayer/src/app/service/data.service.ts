...
export class DataService implements InMemoryDbService {
    ...
    createDb() {
        let playlist = [
            ...
            { 'id': 4, 'title': 'Understanding Javascript', 'url': 'https://www.youtube.com/watch?v=Bv_5Zv5c-Ts', 'status': 'edited', 'approved': 0, 'likes': 25, 'unlike': 5, 'currentStatus': 'stopped', 'exitplayprogress': 80 }
        ];
